...
print('not(a) and(b) is ' . (!$a && $b) );
print('<br/>');
print(' a or b is ' . ( $a || $b) );
print('<br/>');
print('not(a or b) is ' . (!( $a || $b)) );
print('<br/>');
print('a === c is ' . ( $a === $c) );
print('<br/>');
print('a and b or c is ' . ( $a && $b || $c) );
print('<br/>');
print('not(c) == b is ' . ( !$a == $b) );
print('<br/>');
print('a == c is ' . ( $a == $c) );
print('<br/>');
print('not(b) === c is ' . ( !$b === $c) );
print('<br/>');
print('a or not(b) is ' . ( $a || !$b) );
...
print('!(x>6) is ' . ( !$x > 6) );
print('<br/>');
print('x == 6 && x == 5 is ' . ( $x == 6 && $x == 5) );
print('<br/>');
print('x == 6 || x == 5 is ' . ( $x == 6 || $x == 5) );
print('<br/>');
print('x > -1 && y < 10 ' . ( $x > -1 && $y < 10) );
print('<br/>');
