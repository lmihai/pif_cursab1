...
<div class="row">
	...
	<div class="col-sm-4 border background">
		...
		<form name="form2" method="post" action="../Controller/Home.php">
			<br/>
			...
			<br/>
			<input type="checkbox" name="rememberUser" value="Remember me on this computer" checked> Remember me on this computer</input>
			<br/>
